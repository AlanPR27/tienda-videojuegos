...
<div class="container mt-5">
    <div class="container-box text-center">
        ...
        <?php
        if (isset($_SESSION["id_usuario"])) {
            echo "<p>Explora nuestro catálogo para comenzar a comprar.</p>";
        } else {
            echo "<p>Explora nuestro catálogo, inicia sesión o crea una cuenta para comenzar a comprar.</p>";
        }
        ?>
        <div class="mt-4">
            <a href="catalogo.php" class="btn btn-primary me-2">Ver Catálogo</a>
            <?php
            if (!isset($_SESSION["id_usuario"])) {
